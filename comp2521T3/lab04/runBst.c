...
static void runIterativePreOrder(struct node **t, int argc, char *argv[]);
...
static Command COMMANDS[] = {
	...
	{"i", runIterativePreOrder, "",          "iteratively print the pre-order traversal of the BST"},
