...
main:
	...
	#  - $t1: temporary result
	#  - $t2: temporary result
	#  - $t3: final number index
	#  - $t4: final number address
...
scan_loop__end:
	...
	li   $t3, ARRAY_LEN			# t3 = ARRAY_LEN
	addi $t3, $t3, -1             		# t3 = 9
	mul  $t4, $t3, 4			# t4 = 4*t3
	add  $t2, $t2, $t4			# t2 = t2 + t4 = numbers[i]
	lw   $s0, ($t2)              		# s0 = numbers[9]
...
print_loop__body:
	...
	add	$t2, $t2, $t1			#  
	lw	$a0, ($t2)			#
	blt  	$a0, $s0, skip_print   		# if (numbers[i] <= final) 跳过打印
